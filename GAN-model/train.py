...
from models import Generator, Discriminator, Generator_minimal_residual
...
# -------------------------
# Dataset paths
DATASET_NAME = 'all_catch_small'  # Name of the dataset
...
ITERATION_NAME = f'{DATASET_NAME}_unet'  # Name for this training iteration
...
USE_ELASTIC_DEFORMATION = True  # Use elastic deformation in augmentation

# Training parameters
GEN_LEARNING_RATE = 1e-3    # Learning rate for generator
...
DISC_LEARNING_RATE = 1e-1   # Learning rate for discriminator
...
LAMBDA = [50.0,             # Lambda parameter for l1 loss
          100.0             # Lambda parameter for catch-only loss  
]
